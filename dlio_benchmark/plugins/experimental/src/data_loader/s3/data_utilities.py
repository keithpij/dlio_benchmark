...
def create_object_inventory(bucket_name: str, verbose: bool=False) -> Tuple[str, List[Dict[str, str]]]:
    '''
...
def put_image_to_minio(bucket_name: str, object_name: str, image: PIL.Image.Image, client: Optional[Union[Minio, None]]=None) -> None:
    '''
    ...
    try:
        ...
        image_bytes_io = image_to_byte_stream(image)
        content_type = 'application/octet-stream' # 'application/binary'
        response = client.put_object(bucket_name, object_name, image_bytes_io, -1, content_type, part_size = 1024*1024*5)
...
def get_object_list(bucket_name: str, prefix: Optional[Union[str, None]]=None, verbose: bool=False) -> List[str]:
    '''
